...
public User(String correo, String nombre, String apellido, int edad, String contraseña, String telefono, String salt,
		String foto, String detalles, String confirmado, int opcion) {
	super();
	this.correo = correo;
	this.nombre = nombre;
